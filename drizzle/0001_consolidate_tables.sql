...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS ro_verification_status_idx ON ro_verification_cycles (status, diagnosed_at DESC);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS ro_sold_hours_events_week_idx ON ro_sold_hours_events (week_key, captured_at DESC);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS ro_sold_hours_events_v2_week_idx ON ro_sold_hours_events_v2 (week_key, captured_at DESC);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS delta_ai_audits_active_idx ON delta_ai_audits (active DESC, captured_at DESC);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS schedule_snapshots_date_idx ON schedule_snapshots (schedule_date DESC, hour_key DESC);
--> statement-breakpoint
...
CREATE TABLE IF NOT EXISTS tekmetric_paid_ro_history (
	...
	customer_name TEXT NOT NULL,
	vehicle TEXT NOT NULL DEFAULT '',
	ro_url TEXT NOT NULL DEFAULT '',
	posted_date TEXT NOT NULL DEFAULT '',
	odometer_out TEXT NOT NULL DEFAULT '',
	total REAL NOT NULL DEFAULT 0,
	detail_json TEXT NOT NULL DEFAULT '{}',
	updated_at TEXT NOT NULL
);
--> statement-breakpoint
CREATE INDEX IF NOT EXISTS tekmetric_paid_ro_customer_idx ON tekmetric_paid_ro_history(customer_key, posted_date DESC);
--> statement-breakpoint
